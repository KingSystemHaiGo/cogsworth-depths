...
const TEXTS = {
  ...
  'game.codex': { zh: '图 鉴', en: 'CODEX' },
  'codex.title': { zh: '蒸 汽 手 账', en: 'STEAM CODEX' },
  'codex.subtitle': { zh: '击毁 {k} · 改装收录 {u}/{t}', en: '{k} destroyed · {u}/{t} upgrades found' },
  'codex.locked': { zh: '尚未遭遇。', en: 'Not yet encountered.' },
  'codex.kills': { zh: '击毁 ×', en: 'Kills ×' },
  'codex.upgrades': { zh: '— 改装收录 —', en: '— UPGRADES —' },
  'codex.none': { zh: '还没有收录任何改装。', en: 'No upgrades recorded yet.' },
  ...
  'weapon.steamgun': { zh: '蒸汽枪', en: 'Steam Gun' },
  'weapon.rivetgun': { zh: '铆钉霰弹', en: 'Rivet Shotgun' },
  'weapon.railgun': { zh: '磁轨炮', en: 'Railgun' },
  'weapon.hint': { zh: '[Q 切换]', en: '[Q to switch]' },
